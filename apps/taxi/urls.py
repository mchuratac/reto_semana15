...
urlpatterns = [
    ...
    path('crear_destinofavorito/', CrearDestinosFavoritos.as_view(), name = 'crear_destinofavorito'),
    path('editar_destinofavorito/<int:pk>', EditarDestinosFavoritos.as_view(), name='editar_destinofavorito' ),
    path('eliminar_destinofavorito/<int:pk>', EliminarDestinosFavoritos.as_view(), name='eliminar_destinofavorito' )
